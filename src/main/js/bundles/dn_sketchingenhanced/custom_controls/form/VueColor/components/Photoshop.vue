...
<template>
    <div role="application" aria-label="PhotoShop color picker"
            ...
            <div :class="['vc-ps-controls', disableFields ? 'vc-ps-controls__disable-fields' : '']">
                <div class="vc-ps-previews">
                    ...
                    <div class="vc-ps-previews__swatches">
                        <div class="vc-ps-previews__pr-color" :aria-label="`New color is ${colors.hex}`"
                             :style="{background: colors.hex}"></div>
                        <div class="vc-ps-previews__pr-color" :aria-label="`Current color is ${currentColor}`"
                             :style="{background: currentColor}" @click="clickCurrentColor"></div>
                    </div>
